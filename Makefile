...
OBJS = $(BUILD_DIR)/kernel.o $(BUILD_DIR)/screen.o $(BUILD_DIR)/port_io.o $(BUILD_DIR)/keyboard.o $(BUILD_DIR)/idt.o $(BUILD_DIR)/isr.o
...
$(BUILD_DIR)/idt.o: $(SRC_DIR)/idt.c $(SRC_DIR)/include/idt.h
	gcc -m32 -ffreestanding -c $(SRC_DIR)/idt.c -o $(BUILD_DIR)/idt.o

$(BUILD_DIR)/isr.o: $(SRC_DIR)/isr.c $(SRC_DIR)/include/isr.h
	gcc -m32 -ffreestanding -c $(SRC_DIR)/isr.c -o $(BUILD_DIR)/isr.o
